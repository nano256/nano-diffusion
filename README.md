...
|`notebooks/model_architecture.ipynb`|This notebook disects the model architecture and design choices in this repository. It gives you an overview of the different model blocks, what they do, and where you find them in the code base. A great place to check out when you think about tweaking the architecture or have no idea how a diffusion transformer works.| [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/nano256/nano-diffusion/blob/main/notebooks/model_architecture.ipynb) |
